...
const DropdownMenu = ({ name, message }) => {
  ...
  return (
<>
<div className=' md:my-2 sm:mx-[6vw]  mx-[4vw]'>
...
<div className="relative inline-block text-left">
      ...
      {isOpen && (
        <div
          className="  origin-top-right absolute right-0 mt-2 w-[12vw] rounded-md shadow-lg   bg-slate-50 ring-1 ring-black ring-opacity-5 focus:outline-none"
        >
          <div className="py-1" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
          
          

            <a href="#contact" className="block px-4 py-2 text-sm no-underline text-gray-700 hover:bg-gray-100" role="menuitem">
            <Link className=' no-underline' href={'/'}>home </Link>
            </a>
            <a href="#contact" className="block px-4 py-2 text-sm no-underline text-gray-700 hover:bg-gray-100" role="menuitem">
            <Link className=' no-underline' href={'/api'}>react.js </Link>
            </a>
            <a href="#contact" className="block px-4 py-2 text-sm no-underline text-gray-700 hover:bg-gray-100" role="menuitem">
            <Link className=' no-underline' href={'/./'}>css </Link>
            </a>
            <a href="#contact" className="block px-4 py-2 text-sm no-underline text-gray-700 hover:bg-gray-100" role="menuitem">
            <Link className=' no-underline' href={'/api'}>api </Link>
            </a>
            <a href="#contact" className="block px-4 py-2 text-sm no-underline text-gray-700 hover:bg-gray-100" role="menuitem">
            <Link className=' no-underline' href={'https://www.google.com/'}>goole </Link>
            </a>
          </div>
        </div>
      )}
